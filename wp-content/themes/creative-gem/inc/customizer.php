 ...
 */
function creative_gem_customize_register( $wp_customize ) {
  $wp_customize->get_setting( 'blogname' )->transport                              = 'postMessage';
    ...
    $wp_customize->add_panel( 'panel_id', array(
        ...
        'title'          => __('Theme Design Options', 'creative-gem'),
        'description'    => __('Theme Design Options', 'creative-gem'),
        ) ); 

    $wp_customize->add_section( 'creative_gem_styling_settings', array(
        'title'      => __('All Blog Posts Settings','creative-gem'),
        'priority'   => 122,
        'capability' => 'edit_theme_options',

        ) );

    $wp_customize->add_section( 'creative_gem_general_layout', array(
        'title'      => __('General Layout','creative-gem'),
        'priority'   => 1,
        'capability' => 'edit_theme_options',
    ...
    $wp_customize->add_setting('creative_gem_layout', array(
        'capability'        => 'edit_theme_options',
    ...
    $wp_customize->add_control( 'header_left_button_text', array(
        'label'    => __( "Header Left Button Text", 'creative-gem' ),
    ...
    $wp_customize->add_control( 'header_left_button_link', array(
        'label'    => __( "Header Left Button Link", 'creative-gem' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );

    $wp_customize->add_setting( 'header_left_button_bg', array(
        'default'           => '#9b89d2',
        'sanitize_callback' => 'sanitize_hex_color',
        'transport'         => 'postMessage',
        ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_left_button_bg', array(
        'label'       => __( 'Left Button Border Color', 'creative-gem' ),
        'section'     => 'header_image',
        'priority'   => 1,
        'settings'    => 'header_left_button_bg',
        ) ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_left_button_text_color', array(
        'label'       => __( 'Left Button Text Color', 'creative-gem' ),
        'section'     => 'header_image',
        'priority'   => 1,
    ...
    $wp_customize->add_control( 'header_right_button_text', array(
        'label'    => __( "Header Right Button Text", 'creative-gem' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( 'header_right_button_link', array(
        'label'    => __( "Header Right Button Link", 'creative-gem' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_right_button_bg', array(
        'label'       => __( 'Right Button Background Color', 'creative-gem' ),
        'section'     => 'header_image',
        'priority'   => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_right_button_text_color', array(
        'label'       => __( 'Right Button Text Color', 'creative-gem' ),
        'section'     => 'header_image',
        'priority'   => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'top_header_background_color', array(
        'label'       => __( 'Header Background Color', 'creative-gem' ),
    ...
    $wp_customize->add_setting( 'primary_color_picker', array(
        'default'           => '#333677',
        'sanitize_callback' => 'sanitize_hex_color',
        'transport'         => 'postMessage',
        ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'primary_color_picker', array(
        'label'       => __( 'Primary Color', 'creative-gem' ),
        'section'     => 'creative_gem_general_layout',
        'priority'   => 1,
        'settings'    => 'primary_color_picker',
        ) ) );


    $wp_customize->add_section( 'static_front_page', array(
        'title'      => __('Static Front Page','creative-gem'),
        'priority'   => 150,
        'capability' => 'edit_theme_options',

        ) );

    $wp_customize->add_section( 'creative_gem_header_settings', array(
        'title'      => __('Header','creative-gem'),
        'priority'   => 122,
        'capability' => 'edit_theme_options',
        ) );


    $wp_customize->add_section( 'creative_gem_pagination_settings', array(
        'title'      => __('Pagination Type','creative-gem'),
        'priority'   => 122,
        'capability' => 'edit_theme_options',

        ) );

    $wp_customize->add_setting( 'creative_gem_pagination_type', array(
        'default'           => '1',
        'capability'        => 'edit_theme_options',
        'priority'   => 1,
        'sanitize_callback' => 'sanitize_key',
    ...
    $wp_customize->add_control(
        new WP_Customize_Control(
            $wp_customize,
            'creative_gem_pagination_type',

            array(
                'label'     => __('Pagination Type', 'creative-gem'),
                'section'   => 'all_blog_posts',

                'settings'  => 'creative_gem_pagination_type',
                'type'      => 'radio',
                'choices'  => array(
                    '0'   => __('Next/Previous', 'creative-gem'),
                    '1'  => __('Numbered', 'creative-gem'),
                    ),
                'transport' => 'refresh',
                'priority'   => 99,
                )
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'all_blog_posts_headline', array(
        'label'       => __( 'Headline Colors', 'creative-gem' ),
        'section'     => 'all_blog_posts',
        'priority'   => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'all_blog_posts_date', array(
        'label'       => __( 'Date Colors', 'creative-gem' ),
        'section'     => 'all_blog_posts',
        'priority'   => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'all_blog_posts_text', array(
        'label'       => __( 'Text Colors', 'creative-gem' ),
        'section'     => 'all_blog_posts',
        'priority'   => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'all_blog_posts_bg', array(
        'label'       => __( 'Background Color', 'creative-gem' ),
        'section'     => 'all_blog_posts',
        'priority'   => 1,
    ...
    //Breadcrumb
    $wp_customize->add_setting('creative_gem_single_breadcrumb_section', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_key',
        'transport'         => 'refresh',
        'default'           => '1',
        ));
    $wp_customize->add_control('creative_gem_single_breadcrumb_section', array(
        'label'    => __('Breadcrumb Section', 'creative-gem'),
        'section'  => 'creative_single_settings',
        'description' => __('This setting will only affect blog posts.','creative-gem'),
        'settings' => 'creative_gem_single_breadcrumb_section',
        'type'     => 'radio',
        'choices'  => array(
            '1' => __('OFF', 'creative-gem'),
            '0' => __('ON', 'creative-gem'),
            ),
        ));

  
    $wp_customize->add_setting('creative_gem_single_tags_section', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_key',
        'transport'         => 'refresh',
        'default'           => '1',
        ));
    $wp_customize->add_control('creative_gem_single_tags_section', array(
        'label'    => __('Tags Section', 'creative-gem'),
        'section'  => 'creative_single_settings',
        'description' => __('This setting will only affect blog posts.','creative-gem'),
        'settings' => 'creative_gem_single_tags_section',
        'type'     => 'radio',
        'choices'  => array(
            '0' => __('OFF', 'creative-gem'),
            '1' => __('ON', 'creative-gem'),
            ),
        ));


    $wp_customize->add_setting('creative_gem_relatedposts_section', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_key',
        'transport'         => 'refresh',
        'default'           => '1',
        ));
    $wp_customize->add_control('creative_gem_relatedposts_section', array(
        'label'    => __('Related Posts Section', 'creative-gem'),
        'section'  => 'creative_single_settings',
        'description' => __('This setting will only affect blog posts.','creative-gem'),
        'settings' => 'creative_gem_relatedposts_section',
        'type'     => 'radio',
        'choices'  => array(
            '1' => __('OFF', 'creative-gem'),
            '0' => __('ON', 'creative-gem'),
    ...
    $wp_customize->add_setting('creative_gem_authorbox_section', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_key',
        'transport'         => 'refresh',
        'default'           => '1',
        ));
    $wp_customize->add_control('creative_gem_authorbox_section', array(
        'label'    => __('Author box Section', 'creative-gem'),
        'section'  => 'creative_single_settings',
        'description' => __('This setting will only affect blog posts.','creative-gem'),
        'settings' => 'creative_gem_authorbox_section',
        'type'     => 'radio',
        'choices'  => array(
            '1' => __('OFF', 'creative-gem'),
            '0' => __('ON', 'creative-gem'),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'post_page_link', array(
        'label'       => __( 'Link Colors', 'creative-gem' ),
        'section'     => 'creative_single_settings',
        'priority'   => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'post_page_background', array(
     ...
     $wp_customize->get_section('header_image')->title = __( 'Header', 'creative-gem' );
    $wp_customize->get_control( 'background_color'  )->section   = 'creative_gem_general_layout';
    $wp_customize->get_control( 'background_image'  )->section   = 'creative_gem_general_layout';
    $wp_customize->get_control( 'header_textcolor'  )->section   = 'header_image';

}
add_action( 'customize_register', 'creative_gem_customize_register' );





if(! function_exists('creative_gem_color_output' ) ):
function creative_gem_color_output(){

    ?>
    <style type="text/css">
        .related-posts .related-posts-no-img h5.title.front-view-title, #tabber .inside li .meta b,footer .widget li a:hover,.fn a,.reply a,#tabber .inside li div.info .entry-title a:hover, #navigation ul ul a:hover,.single_post a, a:hover, .sidebar.c-4-12 .textwidget a, #site-footer .textwidget a, #commentform a, #tabber .inside li a, .copyrights a:hover, a, .sidebar.c-4-12 a:hover, .top a:hover, footer .tagcloud a:hover,.sticky-text { color: <?php echo esc_attr(get_theme_mod( 'primary_color_picker')); ?>; }
  .total-comments span:after, span.sticky-post, .nav-previous a:hover, .nav-next a:hover, #commentform input#submit, #searchform input[type='submit'], .home_menu_item, .currenttext, .pagination a:hover, .readMore a, .creativegem-subscribe input[type='submit'], .pagination .current, .woocommerce nav.woocommerce-pagination ul li a:focus, .woocommerce nav.woocommerce-pagination ul li a:hover, .woocommerce nav.woocommerce-pagination ul li span.current, .woocommerce-product-search input[type=\"submit\"], .woocommerce a.button, .woocommerce-page a.button, .woocommerce button.button, .woocommerce-page button.button, .woocommerce input.button, .woocommerce-page input.button, .woocommerce #respond input#submit, .woocommerce-page #respond input#submit, .woocommerce #content input.button, .woocommerce-page #content input.button, #sidebars h3.widget-title:after, .postauthor h4:after, .related-posts h3:after, .archive .postsby span:after, .comment-respond h4:after, .single_post header:after, #cancel-comment-reply-link, .upper-widgets-grid h3:after  { background-color: <?php echo esc_attr(get_theme_mod( 'primary_color_picker')); ?>; }
  #sidebars .widget h3, #sidebars .widget h3 a { border-left-color: <?php echo esc_attr(get_theme_mod( 'primary_color_picker')); ?>; }

        .related-posts-no-img, #navigation ul li.current-menu-item a, .woocommerce nav.woocommerce-pagination ul li span.current, .woocommerce-page nav.woocommerce-pagination ul li span.current, .woocommerce #content nav.woocommerce-pagination ul li span.current, .woocommerce-page #content nav.woocommerce-pagination ul li span.current, .woocommerce nav.woocommerce-pagination ul li a:hover, .woocommerce-page nav.woocommerce-pagination ul li a:hover, .woocommerce #content nav.woocommerce-pagination ul li a:hover, .woocommerce-page #content nav.woocommerce-pagination ul li a:hover, .woocommerce nav.woocommerce-pagination ul li a:focus, .woocommerce-page nav.woocommerce-pagination ul li a:focus, .woocommerce #content nav.woocommerce-pagination ul li a:focus, .woocommerce-page #content nav.woocommerce-pagination ul li a:focus, .pagination .current, .tagcloud a { border-color: <?php echo esc_attr(get_theme_mod( 'primary_color_picker')); ?>; }
  .corner { border-color: transparent transparent <?php echo esc_attr(get_theme_mod( 'primary_color_picker')); ?>; }
...
.header-button-border, .header-button-border:hover, .header-button-border:active, .header-button-border:focus { border-color: <?php echo esc_attr(get_theme_mod( 'header_left_button_bg')); ?>; }
        ...
        .post-date-creative, .comment time { color: <?php echo esc_attr(get_theme_mod( 'post_page_date')); ?>; }
    ...
    <?php }
    add_action( 'wp_head', 'creative_gem_color_output' );
    endif;

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function creative_gem_customize_preview_js() {
 wp_enqueue_script( 'creative_gem_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'creative_gem_customize_preview_js' );
