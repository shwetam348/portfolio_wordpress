...
<div id="page" class="single">
	<div class="content">
		<!-- Start Article -->
		<?php if($creative_gem_single_breadcrumb_section == '0') { ?>
		<div class="breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#"><?php creative_gem_the_breadcrumb(); ?></div>
		<?php } ?>
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
				<div class="single_post">
					...
					<header>
						...
						<!-- End Title -->
						<div class="post-date-creative">Posted On <?php the_time( get_option( 'date_format' ) ); ?></div>
					...
					if ($categories) { $category_ids = array(); 
						...
						$my_query = new wp_query( $args ); if( $my_query->have_posts() ) {
							echo '<div class="related-posts"><div class="postauthor-top"><h3>'.__('Related Posts', 'creative-gem').'</h3></div><div class="related-posts-wrapper">';
							...
							while( $my_query->have_posts() ) { 
								...
								<div class="postauthor">
									<h4><?php esc_html_e('About The Author', 'creative-gem'); ?></h4>
